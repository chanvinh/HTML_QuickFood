...
$(".nameCard").click(function() {
    if($(this).parent().hasClass('active')){
        $(this).parent().removeClass('active').find('.contentCard').slideUp(400);
    }else{
        $(this).parent().addClass('active').find('.contentCard').slideDown(400);
        $(this).parent().siblings().removeClass('active').find('.contentCard').slideUp(400);
    }
})
